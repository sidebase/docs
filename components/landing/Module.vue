...
<template>
  <NuxtLink :href="link">
    <div class="card flow-root rounded-lg px-8 pb-8 xl:h-[250px]">
      <div class="-mt-6">
        <div>
        ...
        <p class="mt-2 text-base leading-7 dark:text-gray-400">
          {{ description }}
        </p>
      </div>
    </div>
...
.card:hover {
  ...
  5px 5px 15px rgba(0, 0, 0, 0.5), -5px -5px 15px rgba(255, 255, 255, 0.4);

  @apply dark:bg-purple-700/10;
}
</style>
